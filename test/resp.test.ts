...
const parsedResponse: R4.IQuestionnaireResponse = JSON.parse(
  '{ "resourceType": "QuestionnaireResponse", "item": [{ "linkId": "1", "text": "Do you have allergies?", "answer": [{ "valueBoolean": true }] }, { "linkId": "2.1", "text": "What is your gender?", "answer": [{ "valueString": "Male" }] }, { "linkId": "2.2", "text": "What is your date of birth?", "answer": [{ "valueDate": "12/12/2020" }] }, { "linkId": "2.3", "text": "What is your country of birth?", "answer": [{ "valueString": "Canada" }] }, { "linkId": "2.4", "text": "What is your marital status?", "answer": [{ "valueString": "Married" }] }, { "linkId": "3.1", "text": "Do you smoke?", "answer": [{ "valueBoolean": true }] }, { "linkId": "3.2", "text": "Do you drink alchohol?", "answer": [{ "valueBoolean": true }] }], "status": "in-progress" }'
);
...
describe('map', () => {
  ...
  it('maps formData to fhir response', () => {
    const ff: R4.IQuestionnaireResponse = FhirJsonResp(
      quesR1,
      JSON.parse(formData)
    );
