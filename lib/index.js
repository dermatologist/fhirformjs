...
var fhirformjs = function fhirformjs(fhirjson) {
  ...
  items.forEach(function(item) {
    ...
    if (item.answer !== undefined) {
      ...
      if (item.answer.valueBoolean !== undefined) buffData[itemLinkId] = item.answer.valueBoolean;
      if (item.answer.valueInteger !== undefined) buffData[itemLinkId] = item.answer.valueInteger;
      if (item.answer.valueChoice !== undefined) buffData[itemLinkId] = item.answer.valueChoice;
    }
