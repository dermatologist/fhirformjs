...
var fhirformjs = function fhirformjs(fhirjson) {
  ...
  items.forEach(function(item) {
    ...
    if (item.answer !== undefined) {
      if (item.answer.valueString !== undefined) buff_data[item.linkId] = item.answer.valueString;
      if (item.answer.valueDate !== undefined) buff_data[item.linkId] = item.answer.valueDate;
      if (item.answer.valueBoolean !== undefined) buff_data[item.linkId] = item.answer.valueBolean;
      if (item.answer.valueInteger !== undefined) buff_data[item.linkId] = item.answer.valueInteger;
      if (item.answer.valueChoice !== undefined) buff_data[item.linkId] = item.answer.valueChoice;
    }
