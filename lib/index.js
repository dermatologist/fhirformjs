...
var fhirformjs = function fhirformjs(fhirjson) {
  ...
  items.forEach(function(item) {
    ...
    if (item.answer !== undefined) {
      if (item.answer.valueString !== undefined) buffData[item.linkId] = item.answer.valueString;
      if (item.answer.valueDate !== undefined) buffData[item.linkId] = item.answer.valueDate;
      if (item.answer.valueBoolean !== undefined) buffData[item.linkId] = item.answer.valueBoolean;
      if (item.answer.valueInteger !== undefined) buffData[item.linkId] = item.answer.valueInteger;
      if (item.answer.valueChoice !== undefined) buffData[item.linkId] = item.answer.valueChoice;
    }
